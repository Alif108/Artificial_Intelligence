...
// 3. Post constraints
        ...
        model.arithm(bd[0][6], "=", 6).post();

        model.arithm(bd[1][0], "=", 8).post();
        model.arithm(bd[1][7], "=", 5).post();

        model.arithm(bd[2][0], "=", 7).post();
        model.arithm(bd[2][4], "=", 4).post();

        model.arithm(bd[3][5], "=", 8).post();
        model.arithm(bd[3][8], "=", 1).post();

        model.arithm(bd[4][2], "=", 7).post();

        model.arithm(bd[5][1], "=", 4).post();
        model.arithm(bd[5][2], "=", 6).post();
        model.arithm(bd[5][4], "=", 1).post();
        model.arithm(bd[5][7], "=", 2).post();

        model.arithm(bd[6][3], "=", 3).post();
        model.arithm(bd[6][6], "=", 9).post();

        model.arithm(bd[7][0], "=", 5).post();

        model.arithm(bd[8][1], "=", 2).post();
        model.arithm(bd[8][2], "=", 1).post();
        model.arithm(bd[8][4], "=", 8).post();
        model.arithm(bd[8][7], "=", 6).post();
